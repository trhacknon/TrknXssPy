...
You can upgrade payloads.txt list for up the capabilities of this tool. <link src="https://github.com/trhacknon/XssPy/blob/master/payloads.txt">payloads xss</link> 
